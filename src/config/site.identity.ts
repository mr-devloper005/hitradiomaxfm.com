export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'hitradiomaxfm',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Hitradiomaxfm',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'hitradiomaxfm.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://hitradiomaxfm.com',
